  ...
  return (
    <form action="" className="w-full sm:w-1/2 p-8 bg-white space-y-8">
      <div className="space-y-6 sm:space-y-20">
        ...
        <h2 className="font-black text-center text-xl sm:hidden text-green-600">Bienvenido</h2>
        <h2 className="text-center font-bold sm:font-bold sm:text-xl text-black sm:text-green-600 ">Iniciar Sesión</h2>
      </div>
      <input
        type="text"
