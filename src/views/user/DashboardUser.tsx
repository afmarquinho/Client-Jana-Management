...
const DashboardUser = () => {
  return (
    <div className="flex">
      <div className="w-2/12 bg-green-900">
        <div className="w-full p-4">
          <Link to="/new-user" className="bg-green-400 block w-full p-1 text-center">+ Nuevo Usuario</Link>
        </div>
      ...
      <div className="w-10/12 p-4 pe-0">
        {" "}
              ...
              <tr>
                <td className="px-4 py-4 whitespace-normal text-sm text-gray-900 text-justify">
                  <div className="h-12 w-12 rounded-full overflow-hidden">
                    <img src={perfil} alt="foto" className="object-cover w-full h-full"/>
                  </div>
                </td>
                <td className="px-4 py-4 whitespace-normal text-sm text-gray-900 text-justify">
                  John Doe
                ...
                <td className="px-4 py-4 whitespace-normal text-sm text-gray-900 text-justify">
                  <span className="bg-green-300 px-2 rounded-xl text-green-700 font-semibold text-xs">Activo</span>
                </td>
